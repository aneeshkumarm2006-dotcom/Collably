...
original image-rich "CollabSpace" world (Maple & Oak / Bloom Beauty / etc. with
...
- Advertised logins (password `Password123`): `maya@collably.app` (creator),
  `hello@mapleandoak.ca` (business), `admin@collably.app`. Other accounts exist as
