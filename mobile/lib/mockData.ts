...
export const campaigns: Campaign[] = [
  ...
  },
  {
    ...
    isRemote: false, location: { city: 'Mumbai', state: 'Maharashtra', country: 'India' },
    reward: { type: 'Voucher', description: '₹3,000 dining voucher', estimatedValue: 3000 },
  ...
  },
  {
    ...
    isRemote: false, location: { city: 'Mumbai', state: 'Maharashtra', country: 'India' },
    reward: { type: 'Cash+Product', description: '₹2,000 + festive thali', estimatedValue: 4000 },
  ...
  },
  {
    ...
    reward: { type: 'Voucher', description: '₹1,500 café voucher', estimatedValue: 1500 },
  ...
  },
  {
    ...
    isRemote: true, reward: { type: 'Cash+Product', description: '₹2,500 + 2 pieces', estimatedValue: 5500 },
