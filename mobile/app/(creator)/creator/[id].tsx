/**
 * Public creator profile (PRD §7.3). A read-only view of another creator: avatar,
 * name, UGC badge, bio, niches, social reach, content types, portfolio, and
 * lifetime stats. The creator display name + avatar come from the joined `user`.
 */
