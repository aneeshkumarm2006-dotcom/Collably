...
const ICON_PATHS = {
  ...
  gear: 'M12 15a3 3 0 100-6 3 3 0 000 6zM19.4 13a1.6 1.6 0 00.3 1.7l.1.1a2 2 0 11-2.8 2.8l-.1-.1a1.6 1.6 0 00-2.7 1.1v.2a2 2 0 11-4 0v-.1A1.6 1.6 0 005 17.4l-.1.1a2 2 0 11-2.8-2.8l.1-.1A1.6 1.6 0 002.6 11H2.4a2 2 0 110-4h.1A1.6 1.6 0 004 4.6l-.1-.1a2 2 0 112.8-2.8l.1.1A1.6 1.6 0 009.4 2.6V2.4a2 2 0 014 0v.1A1.6 1.6 0 0019 4.6l.1-.1a2 2 0 112.8 2.8l-.1.1a1.6 1.6 0 00-.4 1.7z',
