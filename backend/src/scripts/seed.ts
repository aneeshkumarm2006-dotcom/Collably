...
const CAMPAIGNS = [
  { key: 'c-1', biz: 'bp-me', title: 'Tasting Menu for Two', category: 'Restaurant', description: 'Join us for our new seasonal tasting menu and capture the experience. We host you and a guest; you share a reel + 3 stories.', isRemote: false, city: 'Toronto', state: 'Ontario', reward: { type: 'Experience', description: '7-course tasting menu for two', estimatedValue: 180 }, deliverables: [{ platform: 'Instagram', contentType: 'Reel', quantity: 1, requirements: 'Tag @mapleandoak, 20s+' }, { platform: 'Instagram', contentType: 'Story', quantity: 3 }], deadline: 12, spotsTotal: 5, spotsRemaining: 3, minFollowers: 2000, status: 'Active', tags: ['food', 'fine-dining', 'toronto'], cover: img('1504674900247-0877df9cc836'), featured: true },
  { key: 'c-2', biz: 'bp-me', title: 'Weekend Brunch Feature', category: 'Restaurant', description: 'Show off our bottomless weekend brunch. Great for lifestyle creators who love a slow Sunday.', isRemote: false, city: 'Toronto', state: 'Ontario', reward: { type: 'Voucher', description: 'Weekend dining voucher', estimatedValue: 90 }, deliverables: [{ platform: 'Instagram', contentType: 'Reel', quantity: 1 }], deadline: 20, spotsTotal: 8, spotsRemaining: 5, minFollowers: 1000, status: 'Active', tags: ['brunch', 'lifestyle'], cover: img('1533920379810-6bedac9e31f4'), featured: false },
  { key: 'c-3', biz: 'bp-me', title: 'Holiday Special Campaign', category: 'Restaurant', description: 'Festive platter shoot for the holiday week. Currently paused while we finalise the menu.', isRemote: false, city: 'Toronto', state: 'Ontario', reward: { type: 'Cash+Product', description: 'Cash + festive platter', estimatedValue: 120 }, deliverables: [{ platform: 'Instagram', contentType: 'Reel', quantity: 1 }], deadline: 35, spotsTotal: 6, spotsRemaining: 6, minFollowers: 3000, status: 'Paused', tags: ['holiday', 'festive'], cover: img('1601050690597-df0568f70950'), featured: false },
  ...
  { key: 'c-5', biz: 'bp-1', title: 'Summer Glow Reels', category: 'Beauty', description: 'Bright, summery reels featuring our SPF range.', isRemote: true, reward: { type: 'Product', description: 'SPF + glow bundle', estimatedValue: 90 }, deliverables: [{ platform: 'Instagram', contentType: 'Reel', quantity: 2 }], deadline: 9, spotsTotal: 12, spotsRemaining: 4, minFollowers: 8000, status: 'Active', tags: ['summer', 'spf'], cover: img('1512496015851-a90fb38ba796'), featured: false },
  { key: 'c-6', biz: 'bp-2', title: '30-Day Fitness Challenge', category: 'Fitness', description: 'Document a 30-day transformation with a free studio membership. Weekly reels.', isRemote: false, city: 'Vancouver', state: 'British Columbia', reward: { type: 'Service', description: '1-month studio membership', estimatedValue: 150 }, deliverables: [{ platform: 'Instagram', contentType: 'Reel', quantity: 4 }], deadline: 30, spotsTotal: 4, spotsRemaining: 2, minFollowers: 10000, status: 'Active', tags: ['fitness', 'challenge', 'vancouver'], cover: img('1571902943202-507ec2618e8f'), featured: false },
  { key: 'c-7', biz: 'bp-3', title: 'Cozy Cafe Mornings', category: 'Cafe', description: 'Capture a slow morning at our book café — coffee, books, soft light.', isRemote: false, city: 'Ottawa', state: 'Ontario', reward: { type: 'Voucher', description: 'Café dining voucher', estimatedValue: 45 }, deliverables: [{ platform: 'Instagram', contentType: 'Photo', quantity: 3 }, { platform: 'Instagram', contentType: 'Story', quantity: 2 }], deadline: 18, spotsTotal: 6, spotsRemaining: 4, minFollowers: 0, status: 'Active', tags: ['cafe', 'cosy', 'ottawa', 'ugc'], cover: img('1442512595331-e89e73853f31'), featured: false },
