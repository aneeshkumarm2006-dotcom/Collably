...
async function main(): Promise<void> {
  ...
  for (const b of businessSeeds) {
    ...
    const profile = await BusinessProfile.create({
      ...
      category: b.category,
      location: { city: b.city, country: 'Canada' },
  ...
  for (const c of creatorSeeds) {
    ...
    const profile = await CreatorProfile.create({
      ...
      niche: c.niche,
      location: { city: c.city, country: 'Canada' },
      socialHandles: {
        instagram: {
  ...
  const campaignSeeds = [
    {
      ...
      category: 'Cafe' as const,
      reward: { type: 'Experience' as const, description: 'Brunch for two', estimatedValue: 80 },
    ...
    },
    {
      ...
      category: 'Salon & Spa' as const,
      reward: { type: 'Service' as const, description: 'Signature facial', estimatedValue: 150 },
      deliverables: [
    ...
    },
    {
      ...
      category: 'Health & Wellness' as const,
      reward: { type: 'Product' as const, description: '7-day meal plan', estimatedValue: 120 },
      deliverables: [
    ...
    },
    {
      ...
      reward: { type: 'Voucher' as const, description: '$50 voucher', estimatedValue: 50 },
  ...
  await Application.create({
    ...
    pitch: 'Beauty creator, 38k followers in Vancouver.',
    status: 'Accepted',
