...
const CREATORS = [
  { key: 'cp-me', user: 'u-creator-me', bio: 'Toronto food & lifestyle creator. I shoot cosy reels of cafés, home recipes and slow weekends.', niche: ['Food', 'Lifestyle'], city: 'Toronto', state: 'Ontario', social: { instagram: { handle: 'mayaeats', link: 'https://instagram.com/mayaeats', followerCount: 18400, verified: true }, youtube: { handle: 'MayaEats', link: 'https://youtube.com/@MayaEats' } }, contentTypes: ['Reel', 'Story', 'Photo'], portfolio: [img('1504674900247-0877df9cc836'), img('1467003909585-2f8a72700288'), img('1490645935967-10de6ba17061')], collabs: 14, earned: 2400, ugc: false },
  { key: 'cp-1', user: 'u-creator-1', bio: 'Fitness & strength content. Vancouver.', niche: ['Fitness', 'Health & Wellness'], city: 'Vancouver', state: 'British Columbia', social: { instagram: { handle: 'liamlifts', link: 'https://instagram.com/liamlifts', followerCount: 32000, verified: true } }, contentTypes: ['Reel', 'Short'], portfolio: [img('1517836357463-d25dfeac3438')], collabs: 9, earned: 1500, ugc: false },
  { key: 'cp-2', user: 'u-creator-2', bio: 'Skincare & beauty reviews you can trust.', niche: ['Beauty'], city: 'Calgary', state: 'Alberta', social: { instagram: { handle: 'chloeglow', link: 'https://instagram.com/chloeglow', followerCount: 51000, verified: true }, youtube: { handle: 'ChloeGlow', link: 'https://youtube.com/@ChloeGlow' } }, contentTypes: ['Reel', 'Review', 'Long Video'], portfolio: [img('1522335789203-aabd1fc54bc9')], collabs: 21, earned: 3900, ugc: false },
  { key: 'cp-3', user: 'u-creator-3', bio: 'Food photographer & café hopper in Ottawa.', niche: ['Food', 'Travel'], city: 'Ottawa', state: 'Ontario', social: { instagram: { handle: 'noaheats', link: 'https://instagram.com/noaheats', followerCount: 8700, verified: true } }, contentTypes: ['Photo', 'Post', 'Story'], portfolio: [img('1414235077428-338989a2e8c0')], collabs: 5, earned: 600, ugc: false },
  { key: 'cp-4', user: 'u-creator-4', bio: 'Slow fashion & sustainable style.', niche: ['Fashion', 'Lifestyle'], city: 'Montreal', state: 'Quebec', social: { instagram: { handle: 'avawears', link: 'https://instagram.com/avawears', followerCount: 27500, verified: true } }, contentTypes: ['Reel', 'Post'], portfolio: [img('1483985988355-763728e1935b')], collabs: 12, earned: 2000, ugc: false },
